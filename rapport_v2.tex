...
\end{tabular}
        ...
        \textit{\large Module : Traitement de Documents et Extraction de Données}
        \vspace*{0.5cm}
...
\begin{enumerate}
    ...
    \item Chapitre 5 : Améliorations futures et perspectives d'évolution.
    \item Chapitre 6 : Conclusion et synthèse.
\end{enumerate}
...
\textbf{Observations}:
\begin{itemize}
    \item ✅ Extraction correcte du nom, email, téléphone.
    \item ✅ Structuration des formations et expériences.
    \item ✅ Reconnaissance et normalisation des compétences techniques.
    \item ⚠️ Parfois manque de lien LinkedIn si la format OCR était dégradée.
    \item ✅ Correctif regex effectué avec succès pour compléter les contacts.
\end{itemize}
...
\textbf{Observations}:
\begin{itemize}
    \item ✅ Extraction de l'en-tête (émetteur/client).
    \item ✅ Numéro et date de facture reconnus.
    \item ⚠️ Tableaux complexes : lignes d'articles partiellement extraites (limitation connue de l'OCR sur structures tabulaires).
    \item ✅ Montants totaux (HT, TTC) correctement extraits.
    \item ⚠️ IBAN/BIC partiellement complétés par la regex si le LLM les omet.
\end{itemize}
...
\textbf{Observations}:
\begin{itemize}
    \item ✅ Champs simples (nom, email, etc.) correctement extraits.
    \item ✅ Détection des cases cochées (si marquées par [x] ou similaire).
    \item ✅ Structuration logique des sections du formulaire.
    \item ⚠️ Texte manuscrit ou mal scanné : reconnaissance partielle.
\end{itemize}
...
% =============================================================================
% CHAPITRE 5 : AMÉLIORATIONS FUTURES
% =============================================================================
...
\begin{itemize}
    \item ✅ Pipeline robuste et modulaire, gérant plusieurs formats d'entrée et types de documents.
    \item ✅ Extraction adaptative : Markdown quand disponible, OCR en fallback.
    \item ✅ Classification automatique du type de document sans apprentissage supervisé.
    \item ✅ Génération de JSON structuré, normalisé et prêt pour l'automatisation.
    \item ✅ Exécution locale : respect de la confidentialité des données.
    \item ✅ Résilience : gestion des erreurs sans interruption de la chaîne globale.
\end{itemize}
