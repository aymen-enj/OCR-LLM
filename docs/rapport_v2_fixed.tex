...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../diagrams/diagramme_flux.png}
    \caption{Diagramme de flux de données (Data Flow) de l'application OCR v3.3}
    \label{fig:pipeline}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../diagrams/diagramme_classes.png}
...
\begin{verbatim}
projet_ocr_fst/
├── ocr_gui.py                # APPLICATION PRINCIPALE (Interface Graphique)
├── ocr_extractor.py          # Moteur backend d'extraction et IA
├── scripts/                  # Scripts utilitaires
│   ├── start_gui.bat         # Lancement rapide
│   └── build_exe.bat         # Compilation .exe
├── docs/                     # Documentation et Rapports
│   ├── presentation.tex      # Présentation Beamer
│   └── rapport_v2_fixed.tex  # Rapport complet LaTeX
├── diagrams/                 # Diagrammes du projet
│   └── diagramme_*.png
├── GUI_GUIDE.md              # Guide utilisateur de l'interface
├── QUICK_START.md            # Guide de démarrage
├── requirements.txt          # Dépendances Python
├── input/                    # Dossier pour vos documents
│   └── (Vos PDF/Images)
└── output/                   # Résultats JSON générés
    ├── mon_cv_data.json
    └── ...
\end{verbatim}
